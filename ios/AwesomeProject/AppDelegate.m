...
{
  // JPush初始化配置
  [JPUSHService setupWithOption:launchOptions appKey:@"ee6b0ae7c80a1605fe528f83"
  ...
  //关闭强制验证https，可允许http图片分享，但需要在info.plist设置安全域名  ReactNative环境配置
