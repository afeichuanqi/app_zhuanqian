...
var ImageViewer = /** @class */ (function (_super) {
    ...
    ImageViewer.prototype.loadImage = function (index) {
        ...
        react_native_1.Image.getSize(image.url, function (width, height) {
            ...
            if (_this.props.onLoadSuccess) {
                _this.props.onLoadSuccess(image.url, width, height);
            }
        }, function () {
            try {
    ...
    ImageViewer.prototype.getContent = function () {
        ...
        var ImageElements = this.props.imageUrls.map(function (image, index) {
            ...
            var Wrapper = function (_a) {
                ...
                return (<react_native_image_pan_zoom_1.default cropWidth={_this.width} cropHeight={_this.height}
                                                               ...
                                                               doubleClickInterval={_this.props.doubleClickInterval} {...others}>
                    {children}
            ...
            switch (imageInfo.status) {
                case 'loading':
                    return (<Wrapper key={index}
                        ...
                        <react_native_1.View
                            style={_this.styles.loadingContainer}>{_this.props.loadingRender()}</react_native_1.View>
                    </Wrapper>);
                case 'success':
                    if (!image.props) {
                        image.props = {};
                    ...
                    return (<react_native_image_pan_zoom_1.default key={index} ref={function (el) {
                        return (_this.imageRefs[index] = el);
                    }} cropWidth={_this.width} cropHeight={_this.height} maxOverflow={_this.props.maxOverflow}
                                                                   horizontalOuterRangeOffset={_this.handleHorizontalOuterRangeOffset}
                                                                   responderRelease={_this.handleResponderRelease}
                                                                   onMove={_this.props.onMove}
                                                                   onLongPress={_this.handleLongPressWithIndex.get(index)}
                ...
                case 'fail':
                    return (<Wrapper key={index} style={_this.styles.modalContainer}
        ...
        return (<react_native_1.Animated.View style={{zIndex: 9}}>
            <react_native_1.Animated.View style={__assign({}, this.styles.container, {opacity: this.fadeAnim})}>
                ...
                <react_native_1.Animated.View style={__assign({}, this.styles.moveBox, {
        ...
        return (<react_native_1.View style={this.styles.menuContainer}>
            ...
            <react_native_1.View style={this.styles.menuContent}>
                <react_native_1.TouchableHighlight underlayColor="#F2F2F2" onPress={this.saveToLocal}
                    ...
                    <react_native_1.Text
                        style={this.styles.operateText}>{this.props.menuContext.saveToLocal}</react_native_1.Text>
                </react_native_1.TouchableHighlight>
                <react_native_1.TouchableHighlight underlayColor="#F2F2F2" onPress={this.handleLeaveMenu}
                                                   style={this.styles.operateContainer}>
                    <react_native_1.Text
    ...
    ImageViewer.prototype.render = function () {
        ...
        return (<react_native_1.View onLayout={this.handleLayout}
