...
export default class NavigationBar extends Component {
    ...
    static propTypes = {
        ...
        showStatusBarHeight: PropTypes.bool,
    ...
    static defaultProps = {
        ...
        showTitle: true,
        contentMiddle: <View></View>,
        showStatusBarHeight: false,
    ...
    render() {
        ...
        let statusBar = !this.props.statusBar.hidden ?
            <View style={[styles.statusBar, this.props.showStatusBarHeight && {height: 20}]}>
                <StatusBar  {...this.props.statusBar} />
            </View> : null;
        // let contentMiddle = <View></View>
        ...
        let content = this.props.hide ? null :
            <View style={styles.navBar}>
                ...
                <View style={[styles.navBarTitleContainer, this.props.titleLayoutStyle]}>
                    {this.props.showTitle ? titleView : this.props.contentMiddle}
                </View>
