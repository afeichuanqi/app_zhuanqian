...
//    public void setSrc(FastImageViewWithUrl view, @Nullable ReadableMap source) {新加
   ...
   final int viewId = view.getId();//新加
        ...
        if (requestManager != null) {
            requestManager
                    ...
                    .into(new SimpleTarget<Drawable>() {
                                            @Override
                                            public void onResourceReady(@NonNull Drawable resource, @androidx.annotation.NonNull Transition<? super Drawable> transition) {
