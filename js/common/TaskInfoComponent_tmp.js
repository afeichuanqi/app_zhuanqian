...
import {_handleTypeTitle, renderEmoji} from '../util/CommonUtils';
    ...
    render() {
        ...
        >
            <FastImage
                ...
                source={require('../res/img/zhiwei.png')}
            ...
            <View style={[{
                ...
                <View
                    ...
                    <View style={{
                        ...
                        <LabelBigComponent contaiStyle={{backgroundColor: '#f5f5f5',}} fontSize={this.props.fontSize} title={_handleTypeTitle(item.typeTitle)}/>
