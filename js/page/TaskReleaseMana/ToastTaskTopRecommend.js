...
class TaskRecommend extends PureComponent {
    ...
    render() {
        ...
        return <View style={{backgroundColor: 'white', paddingHorizontal: 10, paddingBottom: hp(1.5)}}>
            <View style={{paddingVertical: 10}}>
                <Text style={{color: 'rgba(0,0,0,0.8)', width: width - 60, fontSize: hp(1.9)}}>
                    推荐任务将在首页显示
                </Text>
                <Text style={{color: 'rgba(0,0,0,0.8)', width: width - 60, fontSize: hp(1.9), marginTop: 5}}>
                    如果当前任务已经在推荐将增加小时数
                </Text>
                <Text style={{color: 'rgba(0,0,0,0.8)', width: width - 60, fontSize: hp(1.9), marginTop: 5}}>
                ...
                {this.props.item.recommendIsExp == 1 ?
                    <Text style={{color: 'red', width: width - 60, fontSize: hp(1.9), marginTop: 5}}>
                        当前推荐到期时间:{this.props.item.recommendExpTime}
                    </Text> : <Text style={{color: 'red', width: width - 60, fontSize: hp(1.9), marginTop: 5}}>
                        当前没有任何推荐
                    </Text>}
                <TextInput
            ...
            <View style={{height: hp(2.5), backgroundColor: 'white'}}>
                <Text style={{color: 'rgba(0,0,0,0.8)', fontSize:hp(1.9)}}>本次置顶所需金额(包含服务费)：{price}元</Text>
            </View>
        </View>;
